...
last_modified_at: 2026-05-11 15:13:00 +0100
...
I won't attempt to say anything profound here, this is purely for aesthetic enjoyment, much like a lava lamp. The one concession I will make is to run the simulation for longer, where we see that the system eventually breaks down to a bound pair with the third body being ejected:
